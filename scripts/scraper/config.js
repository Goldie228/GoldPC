...
export const CATEGORY_MAP = {
  ...
  'catalog/periferiya_i_aksessuary/myshi': 'mice',
  'catalog/periferiya_i_aksessuary/klaviatury': 'keyboards',
  'catalog/zvuk/naushniki_i_garnitury': 'headphones', // Наушники в разделе Звук на x-core.by
};
...
export const FULL_CATEGORIES = [
  ...
  { path: 'catalog/periferiya_i_aksessuary/myshi', slug: 'mice' },
  { path: 'catalog/periferiya_i_aksessuary/klaviatury', slug: 'keyboards' },
  { path: 'catalog/zvuk/naushniki_i_garnitury', slug: 'headphones' },
];
