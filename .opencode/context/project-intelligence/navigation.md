<!-- Context: project-intelligence/nav | Priority: high | Version: 1.1 | Updated: 2026-05-08 -->
...
**Project Context**:
- `.opencode/context/project/error-detection.md` - Error detection guide for AI agents
...
| Understand the "how" | `technical-domain.md` | Stack, architecture, patterns (UPDATED 2026-05-08) |
