...
export const MOCK_BUILDS: MockBuild[] = [
  {
    ...
    components: [
      ...
      p('ec472d17-6fa2-4eeb-ad4e-684128af4dd0', 'Материнская плата BIOSTAR A520MHP Ver. 6.0', 205, 'motherboard',
        'https://x-core.by/upload/iblock/89d/6npc3n7tri7cp42aievkvvpodrgsvl1g.jpeg',
      ...
      p('f613eafb-0146-4f29-9bfb-65814af23089', 'Оперативная память Kingston FURY Beast 16GB DDR4 3200MHz', 628, 'ram',
        'https://x-core.by/upload/iblock/05b/le14cdsrm18j9xv3o9gq1ndkg4ev391b.jpeg',
      ...
      p('faec7299-9441-4978-8ef3-e797b71fb5f1', 'Вентилятор DeepCool RF120 FS (3шт)', 18, 'fan',
        'https://x-core.by/upload/iblock/887/6vdbymwexp7n56m88cl5j4fukuvx3ck7.jpeg'),
    ],
  },
  {
    id: 'gaming-budget', label: 'Игровой ПК',
    description: 'Игры в 1080p на средних-высоких настройках',
    purpose: 'gaming', tags: ['1080p', 'Gaming', 'RTX'], totalPrice: 4040,
    components: [
      ...
      p('6863d4a0-5974-476d-b83b-a6ed6a696b64', 'Оперативная память Kingston FURY Beast 16GB DDR5 6000MHz', 1004, 'ram',
        'https://x-core.by/upload/iblock/5a0/9yz081tuqzawbq19j1zb71rlffmjbcj6.jpeg',
        [sp('Тип памяти', 'DDR5'), sp('Общий объём', '16 GB'), sp('Тактовая частота', '6000 MHz')]),
  ...
  },
  {
    ...
    components: [
      ...
      p('0c41bc80-e0d3-45f6-8735-0c3df9017092', 'Оперативная память Kingston FURY Beast 2x16GB DDR5 5600MHz', 1717, 'ram',
        'https://x-core.by/upload/iblock/d90/iq5m0tva4f6rbhb06ihrida620ef678r.jpeg',
  ...
  },
  {
    ...
    components: [
      ...
      p('0c41bc80-e0d3-45f6-8735-0c3df9017092', 'Оперативная память Kingston FURY Beast 2x16GB DDR5 5600MHz', 1717, 'ram',
        'https://x-core.by/upload/iblock/d90/iq5m0tva4f6rbhb06ihrida620ef678r.jpeg',
        [sp('Тип памяти', 'DDR5'), sp('Общий объём', '32 GB'), sp('Тактовая частота', '5600 MHz')]),
      p('0d8257c8-847b-4c1c-9011-68e5a19eddce', 'SSD Kingston NV3 1TB NVMe', 662, 'storage',
        'https://x-core.by/upload/iblock/4aa/xjln7qolx43kkgu67pox3divkpd4kstt.jpeg'),
      p('5137dfa4-a087-4fc8-8603-34a3924e3ef6', 'Блок питания DeepCool PF550 550W', 143, 'psu',
        'https://x-core.by/upload/iblock/26d/o95tjoxqkv07xcbg4yw24vonsrq288yl.jpeg'),
      p('068cb49a-7033-4f56-aedc-4817346c4be3', 'Корпус DeepCool Matrexx 30', 115, 'case',
        'https://x-core.by/upload/iblock/e09/ezuoclq42ebz3rpmhda7isrlp0km2d8h.jpeg'),
