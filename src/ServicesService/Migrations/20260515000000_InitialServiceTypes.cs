        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("10000000-0000-0000-0000-000000000005"), "Сборка ПК на заказ", "сборка-пк-на-заказ", "Подбор комплектующих и профессиональная сборка компьютера под ваши задачи: игры, работа, стриминг.", 50.00m, 120, true },
