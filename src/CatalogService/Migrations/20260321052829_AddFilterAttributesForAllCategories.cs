...
{
    /// <inheritdoc />
    public partial class AddFilterAttributesForAllCategories : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("30000000-0000-0000-0000-00000000000c"), "form_factor", new Guid("00000000-0000-0000-0000-000000000007"), "Форм-фактор", 0, 1 },
                    { new Guid("30000000-0000-0000-0000-00000000000d"), "color", new Guid("00000000-0000-0000-0000-000000000007"), "Цвет", 0, 2 },
                    { new Guid("30000000-0000-0000-0000-00000000000e"), "type", new Guid("00000000-0000-0000-0000-000000000008"), "Тип", 0, 1 },
                    { new Guid("30000000-0000-0000-0000-00000000000f"), "socket", new Guid("00000000-0000-0000-0000-000000000008"), "Сокет", 0, 2 },
                    { new Guid("30000000-0000-0000-0000-000000000010"), "tdp", new Guid("00000000-0000-0000-0000-000000000008"), "TDP, Вт", 1, 3 },
                    { new Guid("30000000-0000-0000-0000-000000000011"), "diagonal", new Guid("00000000-0000-0000-0000-00000000000a"), "Диагональ", 0, 1 },
                    { new Guid("30000000-0000-0000-0000-000000000012"), "resolution", new Guid("00000000-0000-0000-0000-00000000000a"), "Разрешение", 0, 2 },
                    { new Guid("30000000-0000-0000-0000-000000000013"), "refresh_rate", new Guid("00000000-0000-0000-0000-00000000000a"), "Частота обновления", 0, 3 },
                    { new Guid("30000000-0000-0000-0000-000000000014"), "type", new Guid("00000000-0000-0000-0000-000000000009"), "Тип устройства", 0, 1 },
                    { new Guid("30000000-0000-0000-0000-000000000015"), "connection", new Guid("00000000-0000-0000-0000-000000000009"), "Подключение", 0, 2 }
                });
